/*---------------------------------------------------------------------------*
  ...
  Revision 1.69  02/28/2005 05:26:13  yosizaki
  do-indent.

  Revision 1.68  02/09/2005 09:18:47  terui
  Added feature to initialize VRAM exclusive control at time of initialization in ARM9.

  Revision 1.67  12/27/2004 04:45:24  takano_makoto
  Added Getter function of register

  Revision 1.66  2004/10/21 13:43:21  yasu
  Change GX_SetVCounterEqVal->GX_SetVCountEqVal

  Revision 1.65  10/08/2004 12:47:19  takano_makoto
  Add GX_IsDispOn (merge to NitroSDK_2_00rc1_branch)

  Revision 1.64.14.1  2004/10/08 12:22:56  takano_makoto
  Add GX_IsDispOn

  Revision 1.64  08/27/2004 09:47:16  takano_makoto
  small fix.

  Revision 1.62  08/10/2004 12:48:35  takano_makoto
  make available to use GX_DMA_NOT_USE.

  Revision 1.61  08/10/2004 09:23:20  takano_makoto
  add GXi_PowerLCD() to GX_Init().

  Revision 1.60  08/03/2004 01:45:16  takano_makoto
  revise GX_SetGraphicsMode to write bgMode and bg0_2d3d always.

  Revision 1.59  07/28/2004 12:23:37  takano_makoto
  Added ASSERT

  Revision 1.57  2004/06/03 08:31:55  yasu
  Add re-initializing guard on TEG vcount workaround

  Revision 1.56  06/02/2004 12:36:01  takano_makoto
  Changed initial value of REG_POWCNT LCD select register to 1.

  Revision 1.55  2004/03/17 07:27:18  yasu
  do sdk_indent

  Revision 1.54  03/08/2004 05:37:18  yada
  VCOUNT190-203 workAround
  Set sync V-Count allowable delay range.     
  ...
  Revision 1.51  02/17/2004 10:43:52  nishida_kenji
  small fix.

  Revision 1.50  02/13/2004 07:08:17  nishida_kenji
  GXS_SetGraphicsMode does not change bit16.

  Revision 1.49  02/06/2004 04:58:23  nishida_kenji
  Exec GX_SetPower(GX_POWER_ALL) in GX_Init().

  Revision 1.47  2004/02/05 07:09:02  yasu
  change SDK prefix iris -> nitro

  Revision 1.46  02/02/2004 02:09:05  nishida_kenji
  GX_Init initializes BG matrices as identity ones.

  Revision 1.45  01/29/2004 23:57:16  nishida_kenji
  DispOn() becomes default.

  Revision 1.44  01/29/2004 04:57:31  nishida_kenji
  GX_Init() becomes smaller in binary size.

  Revision 1.43  01/29/2004 01:15:34  nishida_kenji
  add GX_DispOn, GX_DispOff, GXS_DispOn, GXS_DispOff.
  Also, GX_BlankScr becomes obsolete, please use GX_DispOn/GX_DispOff instead.

  Revision 1.42  01/26/2004 02:38:18  nishida_kenji
  add APIs for the sub 2D engine, and revise GX_SetPower.

  Revision 1.40  01/10/2004 08:49:59  nishida_kenji
  revise GX_Init()

  Revision 1.39  12/25/2003 11:00:09  nishida_kenji
  converted by GX_APIChangeFrom031212-2.pl

  Revision 1.35  12/24/2003 08:13:31  nishida_kenji
  add GX_SetMasterBrightness

  Revision 1.34  12/17/2003 09:00:20  nishida_kenji
  Totally revised APIs.
  build/buildtools/GX_APIChangeFrom031212.pl would help you change your program to some extent.

  Revision 1.33  12/17/2003 08:53:17  nishida_kenji
  revise comments
