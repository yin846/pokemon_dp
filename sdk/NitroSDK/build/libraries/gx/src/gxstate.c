/*---------------------------------------------------------------------------*
  ...
  Revision 1.30  02/28/2005 05:26:13  yosizaki
  do-indent.

  Revision 1.29  02/28/2005 04:26:31  yosizaki
  Minor revisions related to SDK_NO_MESSAGE

  Revision 1.28  12/03/2004 04:31:58  takano_makoto
  Fixed BG RegionCheck due to addition of the GX_SetBankForBGEx function    

  Revision 1.27  11/25/2004 11:29:01  takano_makoto
  add GX_SetBankForBGEx

  Revision 1.26  03/08/2004 02:29:04  takano_makoto
  Modify about GX_VRAM_OBJ_80_EG.

  Revision 1.25  03/04/2004 13:43:31  takano_makoto
  Add GX_VRAM_BG_80_EF, GX_VRAM_BG_80_EG, GX_VRAM_OBJ_80_EF, GX_VRAM_OBJ_80_EG

  Revision 1.24  03/03/2004 05:51:20  kitani_toshikazu
  Fix bugs in GX_RegionCheck_OBJ_().

  Revision 1.23  03/02/2004 09:17:22  nishida_kenji
  Fix bugs in GX_RegionCheck_TexPltt_ and GX_RegionCheck_Tex_.

  Revision 1.22  02/20/2004 07:21:18  nishida_kenji
  Add region checks for Tex and TexPltt.

  Revision 1.21  2004/02/18 00:59:09  yasu
  add ifdef SDK_CW_WARNOFF_SAFESTRB

  Revision 1.20  02/12/2004 08:12:16  nishida_kenji
  Add GX_VRAM_BG_16_G and GX_VRAM_OBJ_16_G.

  Revision 1.19  02/12/2004 07:06:27  nishida_kenji
  avoid generating STRB in THUMB mode.

  Revision 1.17  2004/02/05 07:09:02  yasu
  change SDK prefix iris -> nitro

  Revision 1.16  02/03/2004 01:42:06  nishida_kenji
  Convert magic numbers to macros, and add comments.

  Revision 1.15  02/02/2004 12:29:04  nishida_kenji
  small fix

  Revision 1.14  02/02/2004 05:53:25  nishida_kenji
  small bug fix

  Revision 1.13  01/27/2004 11:14:37  nishida_kenji
  adds APIs for the sub engine.

  Revision 1.12  12/24/2003 08:27:56  nishida_kenji
  ...
  Revision 1.10  12/17/2003 08:53:17  nishida_kenji
  revise comments
