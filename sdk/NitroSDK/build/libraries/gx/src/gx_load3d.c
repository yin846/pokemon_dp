/*---------------------------------------------------------------------------*
  ...
  $Log: gx_load3d.c,v $
  Revision 1.17  01/18/2006 02:11:21  kitase_hirotake
  do-indent
  ...
  Revision 1.14  10/04/2004 13:30:47  takano_makoto
  Add GX_VRAM_CLEARDEPTH_128_* to use clear depth without clear image.

  Revision 1.13  08/10/2004 12:48:35  takano_makoto
  make available to use GX_DMA_NOT_USE.

  Revision 1.12  07/28/2004 11:27:21  takano_makoto
  make possible to change DMA No.

  Revision 1.11  07/09/2004 05:51:37  takano_makoto
  Additional corrections of bug related to noncontiguous allocation of VRAM banks with GX_LoadTexEx and GX_LoadTex.    

  Revision 1.10  07/05/2004 10:09:43  takano_makoto
  Corrected bug related to noncontiguous allocation of VRAM banks with GX_LoadTexEx and GX_LoadTex.    

  Revision 1.9  02/20/2004 07:22:03  nishida_kenji
  Add GX_LoadTexEx and GX_LoadTexPlttEx.

  Revision 1.8  02/17/2004 10:43:52  nishida_kenji
  small fix.

  Revision 1.7  02/13/2004 07:08:42  nishida_kenji
  Use tables instead of switch.

  Revision 1.6  2004/02/12 11:09:02  yasu
  change to new location of include files ARM9/ARM7

  Revision 1.5  02/09/2004 06:36:53  nishida_kenji
  Copy data asynchronously.

  Revision 1.4  2004/02/05 07:09:02  yasu
  change SDK prefix iris -> nitro

  Revision 1.3  01/28/2004 05:41:31  nishida_kenji
