/*---------------------------------------------------------------------------*
  ...
  $Log: fx.c,v $
  Revision 1.15  04/28/2006 07:28:05  okubata_ryoma
  Added FX32_CAST

  Revision 1.14  01/18/2006 02:11:20  kitase_hirotake
  do-indent

  Revision 1.13  02/28/2005 05:26:13  yosizaki
  do-indent.

  Revision 1.12  02/21/2005 00:34:22  yasu
  Changed year of creation.

  Revision 1.11  02/21/2005 00:32:27  yasu
  Support strict form check

  Revision 1.10  03/24/2004 07:31:45  takano_makoto
  Change to return round decimal At FX_Mul.

  Revision 1.9  02/18/2004 09:01:47  nishida_kenji
  Add comments for code32.h.

  Revision 1.8  02/16/2004 02:45:18  nishida_kenji
  FX_Init confirms the size of types/structures.

  Revision 1.7  02/13/2004 00:54:34  nishida_kenji
  Add FX_Modf.

  Revision 1.6  02/05/2004 07:09:02  yasu
  change SDK prefix iris -> nitro

  Revision 1.5  02/03/2004 06:43:03  nishida_kenji
  Add comments.

  Revision 1.4  01/26/2004 07:15:22  nishida_kenji
  revise FX_Mul and FX_Mul32x64c for thumb

  Revision 1.3  01/26/2004 04:57:29  nishida_kenji
  include code32.h

  Revision 1.2  01/16/2004 11:26:01  nishida_kenji
  small fix

  Revision 1.1  01/16/2004 10:40:00  nishida_kenji
