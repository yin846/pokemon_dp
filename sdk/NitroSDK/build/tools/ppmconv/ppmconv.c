/*---------------------------------------------------------------------------*
  ...
  $Log: ppmconv.c,v $
  Revision 1.5  03/17/2006 04:53:00 AM  yasu
  fixed issue where ppm files created in Photoshop (via the NetPBMformats plug-in) could not be read

  Revision 1.4  01/18/2006 02:12:27  kitase_hirotake
  do-indent

  Revision 1.3  02/28/2005 05:26:29  yosizaki
  do-indent.

  Revision 1.2  07/28/2004 08:35:00 AM  yasu
  Add ppmconv8

  Revision 1.1  07/28/2004 07:00:21 AM  yasu
  'ppmconv' as new tool.
