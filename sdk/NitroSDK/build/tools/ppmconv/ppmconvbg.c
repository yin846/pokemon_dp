/*---------------------------------------------------------------------------*
  ...
  $Log: ppmconvbg.c,v $
  Revision 1.7  03/17/2006 04:53:00 AM  yasu
  fixed issue where ppm files created in Photoshop (via the NetPBMformats plug-in) could not be read
  ...
  Revision 1.4  08/11/2004 05:48:35 AM  yasu
  Support -d option to check parameters

  Revision 1.3  08/11/2004 01:39:38 AM  yasu
  Fix a bug around getopt

  Revision 1.2  08/10/2004 05:05:49 AM  yasu
  Fix error message

  Revision 1.1  08/09/2004 09:06:47 AM  yasu
  Add ppmconvbg

  Revision 1.2  08/09/2004 07:59:32 AM  yasu
  add comments

  Revision 1.1  08/09/2004 07:43:07 AM  yasu
  integrated to ppmconvbg

  Revision 1.2  08/09/2004 00:07:52 AM  yasu
  Fix error

  Revision 1.1  08/07/2004 13:42:59 AM  yasu
  Support 16color tool

  Revision 1.1  08/03/2004 10:51:20 AM  yasu
  Add OnScreenWarning
