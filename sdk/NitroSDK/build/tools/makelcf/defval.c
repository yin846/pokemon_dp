/*---------------------------------------------------------------------------*
  ...
  $Log: defval.c,v $
  Revision 1.12  03/29/2006 13:13:22 AM  yasu
  IF-ELSE-ENDIF support

  Revision 1.11  01/18/2006 02:11:19  kitase_hirotake
  do-indent

  Revision 1.10  02/28/2005 05:26:03  yosizaki
  do-indent.

  Revision 1.9  08/05/2004 13:38:44 AM  yasu
  Support -M option

  Revision 1.8  07/10/2004 04:06:17 AM  yasu
  Support command 'Library'
  Support modifier ':x' on template
  Fix up line continue '\'

  Revision 1.7  06/29/2004 04:10:45 AM  yasu
  Use VBuffer to resolve variables

  Revision 1.6  06/23/2004 07:51:07 AM  yasu
  fix a bug as illegal memory freeing at ResolveDefVal()

  Revision 1.5  05/27/2004 00:40:55 AM  yasu
  care also about current directory (dot ".")

  Revision 1.4  05/27/2004 00:25:40 AM  yasu
  care about double-dots ".." for defvalue option :r, :e

  Revision 1.3  05/27/2004 00:11:29 AM  yasu
  fix a error when searching a "dot" of file extension

  Revision 1.2  05/26/2004 12:02:47 AM  yasu
