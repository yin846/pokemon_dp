/*---------------------------------------------------------------------------*
  ...
  $Log: type.h,v $
  Revision 1.3  01/18/2006 02:12:38  kitase_hirotake
  do-indent

  Revision 1.2  02/28/2005 05:26:09  yosizaki
  do-indent.

  Revision 1.1  05/12/2004 02:27:35  terui
  initial upload
...
#define		RTC_INTERRUPT_MODE_32kHz			0x8     // Output 32-kHz periodic wave   
#define		RTC_INTERRUPT_MODE_PULSE			0x1     // Selected frequency periodic interrupt    
#define		RTC_INTERRUPT_MODE_MINUTE_EDGE		0x2     // Edge interrupt -- minutes    
#define		RTC_INTERRUPT_MODE_MINUTE_PULSE1	0x3     // Periodic interrupt 1 at a minute interval (duty 50%)    
#define		RTC_INTERRUPT_MODE_ALARM			0x4     // Alarm interrupt
#define		RTC_INTERRUPT_MODE_MINUTE_PULSE2	0x7     // Interrupt 2 at minute interval    

#define		RTC_INTERRUPT_MASK_32kHz			0x8     // Bit mask that means the time that a 32-kHz periodic interrupt is output    
#define		RTC_INTERRUPT_MASK_PULSE			0xb     // Bit mask that means the time that an interrupt having an period of a selected frequency is output    
#define		RTC_INTERRUPT_MASK_MINUTE_EDGE		0xb     // Bit mask that means the time that a minute edge interrupt is output    
...
/* In the case of multiple setting, high will be output to the interrupt signal line when all of the set pulses become high.
