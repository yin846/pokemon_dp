/*---------------------------------------------------------------------------*
  ...
  $Log: pm.h,v $
  Revision 1.26  01/25/2006 05:49:36  okubata_ryoma
  small fix

  Revision 1.24  2006/01/18 02:12:27  kitase_hirotake
  do-indent

  Revision 1.23  02/28/2005 05:26:25  yosizaki
  do-indent.

  Revision 1.22  11/02/2004 09:46:58  yada
  just fix comment

  Revision 1.21  10/06/2004 08:28:03  yada
  change around sleep callback

  Revision 1.20  10/05/2004 04:13:39  yada
  support pre/post sleep mode callback

  Revision 1.19  08/26/2004 08:32:21  yada
  only fix comment

  Revision 1.18  08/26/2004 08:19:47  yada
  add PM_GetLEDPattern*

  Revision 1.17  08/23/2004 08:06:49  yada
  add LED self blink

  Revision 1.16  08/16/2004 04:14:46  yada
  change argument of PMi_SetLCDPower()

  Revision 1.15  08/10/2004 10:51:39  yada
  LCD power interval become to be controlled with VBlank counter.
  PM_ForcedPowerOff -> PM_ForceToPowerOff

  Revision 1.14  08/09/2004 09:49:28  yada
  delete PM_SetSoundPower/SoundVolume, PM_GetSoundPower/SoundVolume
  (PM -> PMi)

  Revision 1.13  08/09/2004 04:59:43  yada
  add PM_GetSoundPower/SoundVolume/Amp/AmpGain

  Revision 1.12  08/09/2004 01:59:29  yada
  delete async function from PM_Get*

  Revision 1.11  08/07/2004 07:25:29  yada
  PM_CheckBattery -> PM_GetBattery

  Revision 1.10  08/07/2004 07:02:07  yada
  PM_SetForcedPower -> PM_ForcedPowerOff

  Revision 1.9  08/06/2004 12:40:17  yada
  delete power save mode proc

  Revision 1.8  08/05/2004 05:54:15  yada
  create functions about powerSaveMode

  Revision 1.7  08/04/2004 00:44:21  yada
  PM_SetBackLightTop/Bottom -> PM_SetBackLight

  Revision 1.6  08/03/2004 08:40:41  yada
  fix in end sleeping

  Revision 1.5  08/02/2004 12:53:16  yada
  fix a little

  Revision 1.4  08/02/2004 06:14:34  yada
  PM_SetLED, PM_WriteRegister, PM_ReadRegister : PM->PMi
  standby->sleep

  Revision 1.3  08/02/2004 00:35:44  yada
  change some argument in pm api. define enums about pm.

  Revision 1.2  07/31/2004 01:30:45  yada
  add PM_SetAmp, PM_SetAmpGain, PM_SetVDETVoltage

  Revision 1.1  07/29/2004 09:00:50  yada
  initial release
