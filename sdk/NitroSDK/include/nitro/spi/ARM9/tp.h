/*---------------------------------------------------------------------------*
  ...
  $Log: tp.h,v $
  Revision 1.15  01/18/2006 02:12:27  kitase_hirotake
  do-indent

  Revision 1.14  02/28/2005 05:26:26  yosizaki
  do-indent.

  Revision 1.13  12/29/2004 03:59:49  takano_makoto
  ...
  Revision 1.12  12/29/2004 02:09:11  takano_makoto
  Removed retry parameter in SetStability function

  Revision 1.11  2004/06/10 05:27:03  yasu
  Add TP_GetCalibratedResult

  Revision 1.10  06/02/2004 06:15:27  takano_makoto
  Changed arguments for TP_RequestAutoSamplingStart(), TP_SetCallback()

  Revision 1.9  05/21/2004 09:52:51  takano_makoto
  Added TP_GetUserInfo()

  Revision 1.8  05/14/2004 00:41:48  takano_makoto
  Modify Calibrate Parameter format.

  Revision 1.7  04/22/2004 09:02:27  takano_makoto
  Add include type.h and misc.h

  Revision 1.6  04/21/2004 12:08:56  takano_makoto
  Add Async function.

  Revision 1.5  04/19/2004 12:00:36  takano_makoto
  Add TPCommandFlag.

  Revision 1.4  04/16/2004 02:13:53  takano_makoto
  Modify for STRB warning.

  Revision 1.3  04/15/2004 13:55:07  takano_makoto
  Chang any function name.

  Revision 1.2  04/15/2004 11:54:46  takano_makoto
  Change define to NITRO_SPI_ARM9_TP_H

  Revision 1.1  04/15/2004 11:01:26  takano_makoto
  Initial Update.
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    vcount       - Sets the VCOUNT value, which is the base for auto sampling.
                ...
                samplingBufs - Sets the area where auto sampling data will be stored.
                               You must prepare at minimum an area of the size "frequence"
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Requests touch panel values from ARM7, and reads them as calibrated
                values that have been mapped to screen coordinates.     
                Chattering measures have been taken for the data that is acquired here.
                Cannot be used while auto sampling.
