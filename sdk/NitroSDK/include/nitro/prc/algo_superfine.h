/*---------------------------------------------------------------------------*
  ...
  Revision 1.5  03/04/2005 12:45:07  seiki_masashi
  ...
  Revision 1.3  11/04/2004 07:59:53  seiki_masashi
  Revised regularize to normalize

  Revision 1.2  07/19/2004 06:52:06  seiki_masashi
  Arrangement of identifier names

  Revision 1.1  06/30/2004 08:49:45  seiki_masashi
  algo_simple -> algo_light
  algo_standard -> algo_fine
  algo_accurate -> algo_superfine
  Addition of new algo_standard

  Revision 1.5  06/28/2004 13:18:22  seiki_masashi
  Addition of PRC_GetInputPatternStrokes

  Revision 1.4  06/28/2004 11:10:41  seiki_masashi
  Added regularizeSize to prototype patterns list    
  Adjusted parameter types    

  Revision 1.3  06/25/2004 13:32:01  seiki_masashi
  ...
  Revision 1.1  06/24/2004 08:10:04  seiki_masashi
...
/*===========================================================================*
  Set as Standard Functions for Diagram Recognition API *============================================================================    
 *===========================================================================*/
