/*---------------------------------------------------------------------------*
  ...
  $Log: interface.h,v $
  Revision 1.11  03/20/2006 01:58:27  ida
  added the SND_SetMuteTrackEx function

  Revision 1.10  01/18/2006 02:11:21  kitase_hirotake
  do-indent

  Revision 1.9  04/14/2005 06:51:49  ida
  Added SND_PrepareSeq function

  Revision 1.8  03/24/2005 04:35:33  ida
  sound patch for NITRO-System 2005/03/28

  Revision 1.16  03/17/2005 02:11:24  ida
  added the SNDi_SkipSeq function

  Revision 1.15  03/01/2005 02:20:53  ida
  Added the SND_SetTrackPanRange function

  Revision 1.14  02/16/2005 07:47:40  ida
  Added functions to obtain driver information

  Revision 1.13  01/06/2005 04:07:49  ida
  Updated copyright year notation

  Revision 1.12  01/05/2005 06:48:57  ida
  Added SND_SetTrackAllocatableChannel function

  Revision 1.11  10/21/2004 02:14:29  ida
  fix argument name

  Revision 1.10  10/05/2004 06:21:16  ida
  add SND_SetMasterPan

  Revision 1.9  08/10/2004 02:29:41  ida
  add SND_StopUnlockedChannel

  Revision 1.8  08/02/2004 05:36:06  ida
  add SND_SetupChannelPsg

  Revision 1.7  07/13/2004 05:45:40  ida
  SND_SetTrackAllocatableChannel become private

  Revision 1.6  07/09/2004 06:50:21  ida
  add SND_SetTrackAllocatableChannel

  Revision 1.5  07/05/2004 06:32:36  ida
  SNDCaptureId -> SNDCapture

  Revision 1.4  06/28/2004 07:14:52  ida
  change function interface

  Revision 1.3  06/23/2004 06:32:18  ida
  change interface

  Revision 1.2  06/21/2004 01:18:44  ida
  change function interface

  Revision 1.1  06/11/2004 01:54:03  ida
