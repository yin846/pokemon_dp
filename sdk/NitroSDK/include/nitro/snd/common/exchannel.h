/*---------------------------------------------------------------------------*
  ...
  Revision 1.6  04/12/2005 06:15:07  ida
  Moved SND to NITRO-SDK

  Revision 1.12  04/12/2005 00:52:11  ida
  for SDK_FROM_TOOL

  Revision 1.11  03/23/2005 04:47:05  ida
  SDK_FROM_TOOL support

  Revision 1.10  03/02/2005 00:42:26  ida
  Changed so that the pan range is reflected for instrument pan as well

  Revision 1.9  02/16/2005 07:48:49  ida
  Added SND_GetLockedChannel function

  Revision 1.8  10/06/2004 02:24:22  ida
  add user_decay2

  Revision 1.7  10/05/2004 07:01:49  ida
  sequence manage channel counter

  Revision 1.6  08/10/2004 02:29:41  ida
  add SND_StopUnlockedChannel

  Revision 1.5  07/13/2004 05:43:39  ida
  base_note -> original_key

  Revision 1.4  07/09/2004 06:49:33  ida
  change SND_AllocExChannel interface

  Revision 1.3  07/07/2004 05:04:28  ida
  SNDWave -> SNDWaveParam

  Revision 1.2  07/05/2004 06:33:39  ida
  remove SND_StopExChannelAll

  Revision 1.1  06/23/2004 06:33:49  ida
