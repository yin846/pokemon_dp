/*---------------------------------------------------------------------------*
  ...
  $Log: seq.h,v $
  Revision 1.27  03/20/2006 01:58:27  ida
  added the SND_SetMuteTrackEx function

  Revision 1.26  01/18/2006 02:12:28  kitase_hirotake
  do-indent

  Revision 1.25  06/06/2005 01:59:11  ida
  Deleted invalid function declarations

  Revision 1.24  04/14/2005 06:51:49  ida
  Added SND_PrepareSeq function

  Revision 1.23  03/24/2005 04:35:33  ida
  sound patch for NITRO-System 2005/03/28

  Revision 1.18  03/17/2005 02:10:29  ida
  Added SND_SkipSeq function

  Revision 1.17  03/01/2005 02:15:53  ida
  Added pan_range member

  Revision 1.16  01/06/2005 04:07:49  ida
  Updated copyright year notation

  Revision 1.15  01/05/2005 07:09:09  ida
  Added SND_MmlPrintEnable function

  Revision 1.14  07/13/2004 05:44:11  ida
  SND_SetTrackAllocatableChannel become private

  Revision 1.13  07/09/2004 06:50:02  ida
  add SNDTrack::channel_mask

  Revision 1.12  07/05/2004 06:34:07  ida
  add macros

  Revision 1.11  06/23/2004 06:35:15  ida
  channel -> exchannel

  Revision 1.10  05/10/2004 01:58:38  ida
  add volume2(expression) command

  Revision 1.9  05/07/2004 07:38:06  ida
  change struct SNDTrack & SNDPlayer

  Revision 1.8  05/06/2004 04:47:32  ida
  workaround SNDSharedWork

  Revision 1.7  05/06/2004 04:00:44  ida
  add comments

  Revision 1.6  05/06/2004 01:42:01  ida
  use doPeriodicProc flag

  Revision 1.5  05/06/2004 00:45:53  ida
  add comments

  Revision 1.4  04/26/2004 02:26:54  ida
  add SND_Invalidate*()

  Revision 1.3  04/15/2004 05:55:53  ida
  ...
  Revision 1.15  03/25/2004 10:00:04  ida
  workaround loop command

  Revision 1.14  03/24/2004 06:20:46  ida
  add SNDi_SetPlayerParam

  Revision 1.13  03/17/2004 08:47:07  ida
  change porta_time command

  Revision 1.12  03/12/2004 06:43:48  ida
  modify porta command

  Revision 1.11  03/12/2004 05:26:13  ida
  add sweep command

  Revision 1.10  03/12/2004 04:53:31  ida
  add porta_time command

  Revision 1.9  03/12/2004 02:15:32  ida
  add note_finish_wait mode

  Revision 1.8  03/11/2004 02:32:12  ida
  PausePlayer -> PauseSeq

  Revision 1.7  03/10/2004 06:32:58  ida
  SND_Snd -> SND_
  workaround sequence command

  Revision 1.6  03/08/2004 05:40:33  ida
  rename files

  Revision 1.5  02/25/2004 04:15:31  ida
  workaround extVolume

  Revision 1.4  02/25/2004 02:31:55  ida
  remove fadeOut argument
  add SetMasterVolume

  Revision 1.3  02/24/2004 08:08:16  ida
