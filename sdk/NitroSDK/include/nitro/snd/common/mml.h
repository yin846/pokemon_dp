/*---------------------------------------------------------------------------*
  ...
  Revision 1.11  03/25/2004 09:59:08  ida
  add loop command

  Revision 1.10  03/24/2004 06:18:51  ida
  add envelope command

  Revision 1.9  03/17/2004 08:47:07  ida
  change porta_time command

  Revision 1.8  03/12/2004 06:43:48  ida
  modify porta command

  Revision 1.7  03/12/2004 05:26:13  ida
  add sweep command

  Revision 1.6  03/12/2004 04:53:31  ida
  add porta_time command

  Revision 1.5  03/10/2004 06:33:23  ida
  renumbering sequence command

  Revision 1.4  03/08/2004 05:40:33  ida
  rename files

  Revision 1.3  02/23/2004 02:57:32  ida
