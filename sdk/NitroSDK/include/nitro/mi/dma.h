/*---------------------------------------------------------------------------*
  ...
  $Log: dma.h,v $
  Revision 1.48  01/18/2006 02:11:19  kitase_hirotake
  do-indent

  Revision 1.47  03/01/2005 01:57:00  yosizaki
  Revised copyright year

  Revision 1.46  02/28/2005 05:26:02  yosizaki
  do-indent.

  Revision 1.45  11/02/2004 08:58:57  yada
  fix a little

  Revision 1.44  10/21/2004 07:40:01  yada
  just fix typo

  Revision 1.43  10/12/2004 02:04:00  yosizaki
  add MIi_DMA_TIMING_ANY.

  Revision 1.42  10/08/2004 11:59:08  yosizaki
  add MIi_CardDmaCopy.

  Revision 1.41  09/28/2004 04:32:50  yada
  fix MI_SendGXCommand(), add MI_SendGXCommandFast()

  Revision 1.40  08/30/2004 04:30:38  yada
  move some definitions from private folder

  Revision 1.39  08/26/2004 00:11:59  yada
  add MI_SendGXCommandAsyncFast

  Revision 1.38  06/29/2004 04:31:59  yada
  fix typo (if -> is)

  Revision 1.37  06/22/2004 02:05:35  yada
  only change comment

  Revision 1.36  04/07/2004 02:03:17  yada
  fix header comment

  Revision 1.35  02/10/2004 01:20:12  yada
  Moved MI_Cpu* to memory.h

  Revision 1.34  02/05/2004 11:39:03  yada
  Made the *Send*() function's transfer destination pointer volatile.

  Revision 1.33  2004/02/05 07:09:03  yasu
  change SDK prefix iris -> nitro

  Revision 1.32  02/05/2004 01:59:19  yada
  Changed to use UTL_* instead of SVC_*.

  Revision 1.31  02/02/2004 01:51:51  yada
  Corrected an incorrect definition of the value written into the control register    

  Revision 1.30  01/30/2004 05:00:39  yada
  Added MI_DmaSend* and MI_CpuSend*

  Revision 1.29  01/26/2004 12:45:39  yada
  Revised inline

  Revision 1.28  01/19/2004 01:26:49  yada
  Removed "_"  to change the asynchronous function names from xxx_Async to xxxAsync

  Revision 1.27  01/18/2004 04:46:53  yada
  Corrected function name mistakes

  Revision 1.26  01/17/2004 11:47:41  yada
  (none)

  Revision 1.24  01/17/2004 02:28:38  nishida_kenji
  convert 'inline' to 'static inline' in header files

  Revision 1.23  01/16/2004 11:45:13  yada
  convert 'inline' to 'static inline' in header files    

  Revision 1.22  01/06/2004 00:36:46  yada
  Changed the size argument of MI_SendGXCommand* from "the number of commands" to "the number of bytes."

  Revision 1.21  12/25/2003 07:30:24  yada
  Changes as per unified type rules

  Revision 1.20  12/18/2003 07:17:37  yada
  ...
  Revision 1.17  12/11/2003 09:58:30  yada
  Corrected 32 bit-width transfers by MI_CpuCopy16()     

  Revision 1.16  2003/12/09 08:35:26  yasu
  Revamped the area around the memory map    

  Revision 1.15  11/30/2003 05:50:38  yada
  Made it so return when DMA transfer size is 0    

  Revision 1.14  11/28/2003 01:54:21  yada
  Reflects REDSDK 03-11-27

  Revision 1.13  11/26/2003 09:54:41  yada
  (none)

  Revision 1.12  11/26/2003 09:51:17  yada
  Corrected bug describing essential portions of register address as reg_G3X_...    

  Revision 1.11  11/21/2003 12:35:52  yada
  Corrected bug describing essential portions of register address as reg_MI_...    

  Revision 1.10  11/18/2003 00:22:29  yada
  (none)

  Revision 1.9  11/17/2003 02:23:05  yada
  Created INLINE with same origin as source after DMA command without waiting.     

  Revision 1.8  11/14/2003 05:22:22  yada
  The DMA-related definitions have been completely separate from those of the Research & Engineering department.    
  Also, corrected register access macro REG_XXX -> reg_XXX

  Revision 1.7  11/13/2003 06:48:57  yada
  Major revision of DMA process definitions MI_DmaCopy32(...), etc.

  Revision 1.5  11/12/2003 07:50:37  yada
  Corrected GX, G3X definitions

  Revision 1.4  11/12/2003 06:37:55  yada
  For now, created a corrected DMA-related header file.

  Revision 1.3  11/07/2003 07:52:22  yada
  Corrected mistake in DMA0 register's address specification in MI_DmaSet()

  Revision 1.2  11/06/2003 10:37:04  yada
  Corrected #define

  Revision 1.1  11/04/2003 09:09:40  yada
  Initial release.
