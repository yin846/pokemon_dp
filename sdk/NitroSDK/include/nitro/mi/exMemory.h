/*---------------------------------------------------------------------------*
  ...
  $Log: exMemory.h,v $
  Revision 1.34  04/28/2006 11:03:24  yada
  MI_ functions or defines around PhiClock were changed to MIi_

  Revision 1.33  01/18/2006 02:11:19  kitase_hirotake
  do-indent

  Revision 1.32  02/28/2005 05:26:02  yosizaki
  do-indent.

  Revision 1.31  02/09/2005 07:25:29  yada
  change function name CTRDG_SetAgbFastestRomCycle to MI_SetAgbCartridgeFastestRomCycle()

  Revision 1.30  02/04/2005 12:44:02  yada
  add CTRDG_SetAgbFastestRomCycle()

  Revision 1.29  11/12/2004 10:52:42  yada
  fix argument name of MI_SetPhiControl/MI_SetPhiClock

  Revision 1.28  11/04/2004 04:41:20  yada
  fix a little

  Revision 1.27  11/04/2004 04:23:14  yada
  fix a little

  Revision 1.26  07/16/2004 13:53:12  yada
  fix register address MI_GetPhiControl accesses

  Revision 1.25  07/01/2004 07:06:26  yada
  fix MI_Set/GetRomCartridgeCycle1/2 -> 1st/2nd

  Revision 1.24  05/26/2004 01:15:58  yada
  arrange comments

  Revision 1.23  05/25/2004 09:08:33  yada
  change name of function which access cartridge.
  add 'Cartridge'

  Revision 1.22  05/14/2004 10:30:23  takano_makoto
  Change #if SDK_ARM9 -> #ifdef SDK_ARM9

  Revision 1.21  04/07/2004 02:03:17  yada
  fix header comment

  Revision 1.20  03/25/2004 07:26:05  yada
  MIi_SetMainMemoryPriority to MI_-

  Revision 1.19  03/25/2004 02:38:01  yada
  ...
  Revision 1.18  03/25/2004 02:19:48  yada
  Made so that ARM7 does not define MI_SetMainMemoryPriority(), MI_SetCardProcessor(), 
  MI_SetCartridgeProcessor() entities

  Revision 1.17  03/12/2004 12:11:42  yada
  only arrange spacing

  Revision 1.16  03/10/2004 01:17:41  yada
  Revised ASSERT

  Revision 1.15  03/09/2004 09:56:05  yada
  Changes in line with ARM7 side EXMEMCNT_L, EXMEMCNT_H descriptions

  Revision 1.14  02/12/2004 13:33:09  yasu
  include nitro/ioreg.h

  Revision 1.13  02/12/2004 10:56:04  yasu
  new location of include files ARM9/ARM7

  Revision 1.12  02/05/2004 12:21:14  yasu
  change SDK prefix iris -> nitro

  Revision 1.11  02/05/2004 07:09:03  yasu
  change SDK prefix iris -> nitro

  Revision 1.10  01/17/2004 02:28:38  nishida_kenji
  convert 'inline' to 'static inline' in header files

  Revision 1.9  01/16/2004 07:28:45  yada
  Corrected 'processor' assert

  Revision 1.8  01/14/2004 01:42:55  yada
  Changed function names
  OS_IrisCardPriority -> OS_CardProcessor
  OS_CartridgePriority -> OS_CartridgeProcessor

  Revision 1.7  01/08/2004 06:01:03  yada
  Phi is not Physical. Revised names

  Revision 1.6  12/25/2003 09:42:57  yada
  Corrected ASSERT bug

  Revision 1.5  12/25/2003 07:30:28  yada
  Changes as per unified type rules

  Revision 1.4  12/18/2003 12:15:15  yada
  Added 'assertion'

  Revision 1.3  12/18/2003 07:16:40  yada
  Changed from red-sdk specification

  Revision 1.2  12/08/2003 12:17:34  yada
  Made significant changes

  Revision 1.1  11/28/2003 01:55:30  yada
